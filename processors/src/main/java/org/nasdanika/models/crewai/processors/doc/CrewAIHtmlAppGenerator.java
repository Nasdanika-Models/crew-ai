package org.nasdanika.models.crewai.processors.doc;
...
public class CrewAIHtmlAppGenerator extends HtmlAppGenerator {
	...
	public CrewAIHtmlAppGenerator(
			...
			CrewAINodeProcessorFactory nodeProcessorFactory) {
...
//			Map.entry(ArchitecturePackage.eINSTANCE, URI.createURI("https://architecture.models.nasdanika.org/")));
	...
	public CrewAIHtmlAppGenerator(EObject source, CrewAINodeProcessorFactory nodeProcessorFactory) {
		this(source, URI.createURI("tmp://" + UUID.randomUUID() + "/" + UUID.randomUUID() + "/"), nodeProcessorFactory);
	}
	
	public CrewAIHtmlAppGenerator(EObject source) {
		this(source, new CrewAINodeProcessorFactory(Context.EMPTY_CONTEXT, null));
	}
