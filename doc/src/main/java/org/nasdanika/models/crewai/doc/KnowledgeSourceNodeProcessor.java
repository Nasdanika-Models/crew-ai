...
public class KnowledgeSourceNodeProcessor extends EObjectNodeProcessor<KnowledgeSource> {
	...
	public void configureLabel(Object source, Label label, ProgressMonitor progressMonitor) {
		...
		if (source == getTarget() && label instanceof Action) {
			...
			if (uri != null && location != null && uri.toString().equals(location)) {
				label.setIcon("https://crew-ai.models.nasdanika.org/images/book.svg");
			}
		}		
	}
