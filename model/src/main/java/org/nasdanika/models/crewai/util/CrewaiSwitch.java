	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CrewaiPackage.CREW: {
				...
				if (result == null) result = caseArchitectureDescriptionElement(crew);
				if (result == null) result = caseDocumentedNamedGraphElement(crew);
				if (result == null) result = caseArchitectureElement(crew);
				if (result == null) result = caseUndergoer(crew);
				if (result == null) result = caseGraphElement(crew);
				if (result == null) result = caseDocumentedNamedStringIdentity(crew);
				if (result == null) result = casePeriod(crew);
				if (result == null) result = caseStringIdentity(crew);
				if (result == null) result = caseSemanticElement(crew);
